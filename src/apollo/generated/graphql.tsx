...
export type GetPeopleQuery = { __typename?: 'Root', allPeople: Maybe<{ __typename?: 'PeopleConnection', totalCount: Maybe<number>, people: Maybe<Array<Maybe<{ __typename?: 'Person', id: string, name: Maybe<string>, mass: Maybe<number>, birthYear: Maybe<string>, hairColor: Maybe<string>, height: Maybe<number>, skinColor: Maybe<string>, homeworld: Maybe<{ __typename?: 'Planet', id: string, name: Maybe<string> }>, species: Maybe<{ __typename?: 'Species', id: string, name: Maybe<string> }>, vehicleConnection: Maybe<{ __typename?: 'PersonVehiclesConnection', vehicles: Maybe<Array<Maybe<{ __typename?: 'Vehicle', id: string, name: Maybe<string> }>>> }> }>>>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, startCursor: Maybe<string>, endCursor: Maybe<string> } }> };
